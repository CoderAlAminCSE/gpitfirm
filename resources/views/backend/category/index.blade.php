                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <form id="SearchForm" action="{{ route('service.category.index') }}" method="get">
                                    @csrf
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    @forelse ($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="badge {{ $category->active == 1 ? 'badge-light-success' : 'badge-light-danger' }}">
                                                    {{ $category->active == 1 ? 'Active' : 'Inactive' }} </div>
                                            </td>
                                            <td class="text-end">
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a class="menu-link px-3 btn-category-delete"

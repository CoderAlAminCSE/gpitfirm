        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Reseller Rules Page Content</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('pages.reseller-rules.update') }}" method="POST"
...
@section('script')
    ...
    <script src="{{ asset('assets/backend') }}/js/resellerRulesPage.js"></script>
@endsection

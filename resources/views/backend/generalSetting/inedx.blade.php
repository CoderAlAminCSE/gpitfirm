                                    ...
                                    <div class="tab-pane fade show active" id="kt_ecommerce_settings_general"
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span class="required">Company Phone</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Set company phone number.">
                                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span class="required">USA Location</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                    name="usa_location"
                                                    value="{{ siteSetting('usa_location') ?? null }}" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span class="required">BD Office Address</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Set company address.">
                                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                            <span class="path1"></span>
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                ...
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span>About Us</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Set small description about your company.">
                                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>

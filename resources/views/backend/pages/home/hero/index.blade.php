    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route('pages.home.hero.update') }}" method="POST"
                    ...
                    <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px"
                                        style="background-image: url('{{ !empty(homePageHeroSection('image')) ? asset('storage/' . homePageHeroSection('image')) : url('assets/backend/upload/no_image.jpg') }}')">
                                    </div>
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Button</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">

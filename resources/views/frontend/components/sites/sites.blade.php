<section class="ptb-10">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <table id="sites_data_table" class="table table-striped table-bordered display no-wrap" cellspacing="0" style="width:100%">
                    <thead>
                        <tr>
                            <th>Website URL</th>
                            <th>Moz DA</th>
                    ...
                    <tbody>
                        <tr>
                            <td><a href="https://naasongs.fun/" target="_blank">naasongs.fun</a></td>
                            <td>53</td>
                            <td>42</td>
                            <td>61</td>
                            <td>160K</td>
